...
#include <QVBoxLayout>
#include <QHBoxLayout>
#include "guieditablewidgetlist.h"
#include "guiwidgetlistitem.h"
#include "widgetitemcontents.h"
#include "ui_guiwidgetlist.h"

plugframe::GuiEditableWidgetList::GuiEditableWidgetList(bool controlPanelActivated,
...
plugframe::GuiEditableWidgetList::~GuiEditableWidgetList()
{
    delete ui;
}

void plugframe::GuiEditableWidgetList::reset()
{
    QWidget *w;
    QLayoutItem *il;
...
void plugframe::GuiEditableWidgetList::setScrollListMinimumSize(const QSize &s)
{
    ui->guiWidgetListScrollArea->setMinimumSize(s);
}

void plugframe::GuiEditableWidgetList::displayItem(GuiWidgetListItem *item)
{
    WidgetItemContents *itemContents;

    // item container
    itemContents = createItemContents(m_itemControlPanelActivated,ui->widgetListContents);
...
void plugframe::GuiEditableWidgetList::setEnabledLockUnlockButton(bool enabled)
{
...
plugframe::WidgetItemContents *plugframe::GuiEditableWidgetList::createItemContents(bool controlPanelActivated,QWidget *parent)
{
    return new WidgetItemContents{controlPanelActivated,parent};
}

void plugframe::GuiEditableWidgetList::onLockUnlockButton()
{
    if (m_toLock)
    {
        if (m_selectedItem)
...
void plugframe::GuiEditableWidgetList::onAddButton()
{
...
void plugframe::GuiEditableWidgetList::onUpdateButton()
{
    editStateControlPanel();
    if (m_selectedItem)
    {
...
void plugframe::GuiEditableWidgetList::onDeleteButton()
{
    editStateControlPanel();
    if (m_selectedItem)
    {
...
void plugframe::GuiEditableWidgetList::onItemLeaveEvent(WidgetItemContents *item)
{
    if(m_toLock)
    {
...
void plugframe::GuiEditableWidgetList::onItemEnterEvent(WidgetItemContents *item)
{
    if(m_toLock)
    {
        // The list is currently unlocked
...
void plugframe::GuiEditableWidgetList::onItemMouseReleaseEvent(WidgetItemContents *item)
{
    if(m_toLock)
    {
        // The list is currently unlocked
...
void plugframe::GuiEditableWidgetList::onUpdatedItemContainer(WidgetItemContents *item)
{
...
void plugframe::GuiEditableWidgetList::lockList()
{
    int nbItemContents;
    WidgetItemContents *itemContents;
    QLayoutItem *il;
...
void plugframe::GuiEditableWidgetList::lockControlPanel()
{
    //lockList();
...
void plugframe::GuiEditableWidgetList::unlockControlPanel()
{
    //unlockList();
...
void plugframe::GuiEditableWidgetList::editStateControlPanel(bool edit)
{
    if (edit)
    {
        if(m_selectedItem)
...
plugframe::WidgetItemContents *plugframe::GuiEditableWidgetList::addListItemContents()
{
    WidgetItemContents *itemContents;
...
void plugframe::GuiEditableWidgetList::addItem(WidgetItemContents *container, GuiWidgetListItem *content)
{
    if (content)
    {
    ...
    ui->widgetListContentsLayout->addWidget(container,0,Qt::AlignTop);
}

void plugframe::GuiEditableWidgetList::selectItemContents(WidgetItemContents *item)
{

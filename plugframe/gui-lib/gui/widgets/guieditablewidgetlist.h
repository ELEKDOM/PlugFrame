...
//
#ifndef GUIEDITABLEWIDGETLIST_H
#define GUIEDITABLEWIDGETLIST_H
...
///
/// \brief The GuiEditableWidgetList class
...
class PFGUILIB_EXPORT GuiEditableWidgetList : public QWidget
{
    Q_OBJECT

public:
    explicit GuiEditableWidgetList(bool controlPanelActivated = true,
    ...
    ~GuiEditableWidgetList() override;

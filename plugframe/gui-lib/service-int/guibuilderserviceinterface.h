...
public:
    virtual void addGuiController(const QspGuiPageController& controller,const GuiMainMenuNames& menuNames) = 0;
    virtual void removeAllPages(const QspGuiPageController& controller) = 0;
    virtual void setMainWindowTitle(const QString& title) = 0;
};
}//namespace plugframe

#define PfGuiBuilderService_iid "plugframe.GuiBuilderServiceInterface"
Q_DECLARE_INTERFACE(plugframe::GuiBuilderServiceInterface, PfGuiBuilderService_iid)

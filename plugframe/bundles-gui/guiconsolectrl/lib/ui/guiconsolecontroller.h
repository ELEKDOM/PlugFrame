...
public:
    GuiConsoleController(QObject *parent = nullptr);
    ~GuiConsoleController() override;

public:
    void platformItf(plugframe::SystemServiceInterface *systemServiceItf) {m_systemServiceItf = systemServiceItf;}
...
using QspGuiConsoleController = QSharedPointer<GuiConsoleController>;
